...
import com.akhil.repository.BookingRepository;
...
public class BookingServiceImpl implements BookingService {
    ...
    public Boolean isSameDate(LocalDateTime dateTime,LocalDate date ){
        ...
        boolean equals = dateTime.toLocalDate().equals(date);
        return equals;
    ...
    public SalonReport getSalonReport(Long salonId) {
        ...
        List<Booking> bookings = getBookingBySalon(salonId);
         ...
         List<Booking> cancelledBookings = bookings.stream().filter(booking -> booking.getStatus().equals(BookingStatus.CANCELED)).toList();
