  ...
  return (
    <div className="z-50 px-6 flex items-center justify-between py-2 fixed top-0 left-0 right-0 bg-white shadow-md">
      ...
      <div className="flex items-center gap-10">
        ...
        <h1
          onClick={() => navigate("/")}
          className="cursor-pointer font-extrabold text-2xl lg:text-3xl text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-pink-500 to-orange-400 tracking-wide hover:scale-105 transition-transform duration-300"
        >
          Salon <span className="text-black">Service</span>
        </h1>
